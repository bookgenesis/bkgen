...
def document(elem, **params):
    ...
    for e in Document.xpath(root, "//pub:colbreak"):
        e.tail = '\n'
    ...
    for e in Document.xpath(root, "//html:img"):
        ...
        if e.get('href_fmt') is not None:
            e.attrib.pop('href_fmt')
    ...
    for e in Document.xpath(root, "//html:td | //html:Cell"):
        ...
        if e.get('{%(aid)s}table' % NS) is not None:
            e.attrib.pop('{%(aid)s}table' % NS)
        if e.get('aid-table') is not None:
            e.attrib.pop('aid-table')
        ...
        if e.get('class') == '':
            e.attrib.pop('class')
        if e.get('{%(aid5)s}cellstyle' % NS) is not None:
            e.attrib.pop('{%(aid5)s}cellstyle' % NS)
        if e.get('aid5-cellstyle') is not None:
        ...
        if e.get('{%(aid)s}crows' % NS) is not None:
            e.attrib.pop('{%(aid)s}crows' % NS)
        if e.get('aid-crows') is not None:
        ...
        if e.get('{%(aid)s}ccols' % NS) is not None:
            e.attrib.pop('{%(aid)s}ccols' % NS)
        if e.get('aid-ccols') is not None:
            e.attrib.pop('aid-ccols')
        ...
        if e.get('width') == 'pt':
            e.attrib.pop('width')
        if e.get('{%(aid)s}ccolwidth' % NS) is not None:
            e.attrib.pop('{%(aid)s}ccolwidth' % NS)
        if e.get('aid-ccolwidth') is not None:
            e.attrib.pop('aid-ccolwidth')
    ...
    for e in Document.xpath(root, "//html:table"):
        ...
        if e.get('class') == '':
            e.attrib.pop('class')
        if e.get('{%(aid5)s}tablestyle' % NS) is not None:
            e.attrib.pop('{%(aid5)s}tablestyle' % NS)
        if e.get('aid5-tablestyle') is not None:
            e.attrib.pop('aid5-tablestyle')
        ...
        if e.get('{%(aid)s}tcols' % NS) is not None:
            e.attrib.pop('{%(aid)s}tcols' % NS)
        if e.get('aid-tcols') is not None:
            e.attrib.pop('aid-tcols')
        ...
        if e.get('{%(aid)s}trows' % NS) is not None:
            e.attrib.pop('{%(aid)s}trows' % NS)
        if e.get('aid-trows') is not None:
            e.attrib.pop('aid-trows')
